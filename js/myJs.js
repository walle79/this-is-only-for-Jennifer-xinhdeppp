const textConfig = {
  ...
  text10: "Anh biết mà ^^ Yêu pé 300.000",
  text11:
    "Pé đồng ý làm người iu a nhaaa :v Còn giờ thì pé xem hết bí mật này nè!",
  text12: "Okii lunn <3",
};
    ...
    Swal.fire({
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://walle79.github.io/heart-emotion/";
          },
        });
      }
    });
